...
const GameCard = ({
  ...
  <div className="relative">
    <Link
      href={href}
      className="group relative z-10 flex h-full flex-col justify-between overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-6 ring-1 ring-white/10 transition-transform duration-300 hover:-translate-y-1"
    >
      <div>
...
// --- POLISH: Added keyframes for the fade-in animation in tailwind.config.js (or globals.css) ---
// You would add this to your tailwind.config.js file or a globals.css file to make the animation work.
/*
